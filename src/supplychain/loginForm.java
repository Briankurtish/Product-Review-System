...
public class loginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        unameTb.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N

        passTb.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(unameTb, javax.swing.GroupLayout.DEFAULT_SIZE, 181, Short.MAX_VALUE)
                    .addComponent(passTb))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // for the Admin
        else if(unameTb.getText().equals("Admin") && passTb.getText().equals("passadmin"))
        {
        ...
        else if(unameTb.getText().equals("Dealer") && passTb.getText().equals("passdealer"))
        {
            JOptionPane.showMessageDialog(this, "Welcome Dealer");
            new DealerModule().setVisible(true);
            this.dispose();
            
        }
        else if(unameTb.getText().equals("Client") && passTb.getText().equals("passclient"))
        {
